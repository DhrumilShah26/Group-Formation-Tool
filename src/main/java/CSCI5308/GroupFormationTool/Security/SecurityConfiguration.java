...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter
{
	...
	final
	IGlobalFactoryProvider globalFactoryProvider;

	public SecurityConfiguration(IGlobalFactoryProvider factoryProvider) {
		this.globalFactoryProvider = factoryProvider;
	}
	...
	{
		return new CustomAuthenticationManager(globalFactoryProvider);
	}
}
